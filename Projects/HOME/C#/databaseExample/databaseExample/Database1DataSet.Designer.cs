...
namespace databaseExample {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PersonRow AddPersonRow(int Id, string Name, string PhoneNumber) {
...
namespace databaseExample.Database1DataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Person] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_N" +
                "ame) AND ([PhoneNumber] = @Original_PhoneNumber))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Person] ([Id], [Name], [PhoneNumber]) VALUES (@Id, @Name, @Pho" +
                "neNumber);\r\nSELECT Id, Name, PhoneNumber FROM Person WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Person] SET [Id] = @Id, [Name] = @Name, [PhoneNumber] = @PhoneNumbe" +
                "r WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([PhoneNumber] " +
                "= @Original_PhoneNumber));\r\nSELECT Id, Name, PhoneNumber FROM Person WHERE (Id =" +
                " @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::databaseExample.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, PhoneNumber FROM dbo.Person";
