"""This program creates a calendar that the user can interact with from the command line. It allows the user to: view the calendar, add 
an event to the calendar, update an existing event, delete an existing event"""

from time import sleep, strftime, localtime
USER_NAME = "Yash Djson Dookun"
calendar = {}
